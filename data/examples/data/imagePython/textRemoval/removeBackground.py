...
def removeBackground(hMin, sMin, vMin, hMax, sMax, vMax, binarizedValue):
    # Load in image
    image = cv2.imread('shino/shino1.png')
    ...
    cv2.imwrite("output.png", inverseBinarizedOutput) 

    return "color processing completed"


removeBackground(hMin=0, sMin=0, vMin=187, hMax=179, sMax=255, vMax=255, binarizedValue=1)